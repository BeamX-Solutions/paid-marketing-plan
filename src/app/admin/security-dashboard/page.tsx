    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#0F5AE0] mx-auto"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className={`text-2xl font-bold ${
                ...
                data.securityScore.grade === 'B' ? 'text-[#0F5AE0]' :
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="text-center">
              <div className="text-4xl font-bold text-[#0F5AE0]">
            ...
            <div className="mt-4 text-center">
              <Link
                ...
                className="text-sm text-[#0F5AE0] hover:text-[#0C48B3] cursor-pointer transition-colors duration-300 font-medium"
              >
                Enable 2FA →
              </Link>
            </div>
        ...
        <div className="mt-8 bg-white rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link
              href="/admin/audit-logs"
              className="flex items-center p-4 border border-gray-200 rounded-lg hover:border-[#0F5AE0] hover:bg-blue-50 cursor-pointer transition-colors"
            >
              <svg className="h-8 w-8 text-[#0F5AE0] mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
